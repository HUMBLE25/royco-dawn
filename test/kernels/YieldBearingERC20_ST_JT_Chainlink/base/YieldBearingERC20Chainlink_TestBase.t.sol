...
/// @notice Base test contract for YieldBearingERC20_ST_YieldBearingERC20_JT_IdenticalAssetsChainlinkOracleQuoter_Kernel
...
abstract contract YieldBearingERC20Chainlink_TestBase is AbstractKernelTestSuite {
    ...
    function _getStoredConversionRate() internal view returns (uint256) {
        return YieldBearingERC20_ST_YieldBearingERC20_JT_IdenticalAssetsChainlinkOracleQuoter_Kernel(address(KERNEL)).getStoredConversionRateRAY();
    }
    ...
    function _setStoredConversionRate(uint256 _newRateRAY) internal {
        ...
        YieldBearingERC20_ST_YieldBearingERC20_JT_IdenticalAssetsChainlinkOracleQuoter_Kernel(address(KERNEL)).setConversionRate(_newRateRAY);
    }
