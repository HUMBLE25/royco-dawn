...
contract ERC4626ST_AaveV3JT_Kernel is ERC4626STKernel, AaveV3JTKernel {
    ...
    function initialize(RoycoKernelInitParams calldata _params, address _owner, address _pauser, address _stVault, address _aaveV3Pool) external initializer {
        ...
        __RoycoKernel_init(_params, _owner, _pauser);
