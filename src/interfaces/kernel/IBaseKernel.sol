...
interface IBaseKernel {
     ...
     */
    function maxDeposit(address _caller, address _reciever, address _asset) external view returns (uint256);
     ...
     */
    function maxWithdraw(address _caller, address _reciever, address _asset) external view returns (uint256);
