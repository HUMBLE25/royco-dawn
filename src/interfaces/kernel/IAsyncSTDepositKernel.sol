...
interface IAsyncSTDepositKernel {
     ...
     * @param _caller The address of the user requesting the cancelation of a deposit request for the senior tranche
     * @param _requestId The request ID of this deposit request
     ...
     */
    function stClaimableCancelDepositRequest(uint256 _requestId, address _controller) external view returns (uint256 assets);
}
