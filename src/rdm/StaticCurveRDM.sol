...
contract StaticCurveRDM is IRDM {
    ...
    /// @inheritdoc IRDM
    function getRewardDistribution(bytes32, uint256 _stPrincipalAmount, uint256 _jtTotalAssets, uint256 _coverageWAD) external pure returns (uint256) {
        /**
        ...
        if (_stPrincipalAmount == 0 || _jtTotalAssets == 0 || _coverageWAD == 0) return 0;
