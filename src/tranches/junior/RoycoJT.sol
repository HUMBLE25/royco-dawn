...
contract RoycoJT is BaseRoycoTranche {
     ...
     */
    function initialize(TrancheDeploymentParams calldata _jtParams, address _asset, address _owner, bytes32 _marketId) external initializer {
        // Initialize the Royco Junior Tranche
        __RoycoTranche_init(_jtParams, _asset, _owner, _marketId);
    }
